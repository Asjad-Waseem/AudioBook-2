  ...
  setGlobalState({collapsed1: !collapsed1})
    ...
    return (
      ...
      <Sider trigger = {null} collapsible collapsed={collapsed1} theme = "light" className = "sider" collapsedWidth = {50}>      
        ...
        <Menu defaultSelectedKeys={['sasda']} mode="inline" className = {collapsed1 ? "collapsed-menu" : "regular-menu"}>
        ...
        />}>
          ...
          <img src = {require("../Assets/Images/notification.png")} alt = "img2" style = {{height: '11px', width: '11px', marginLeft: "40px"}}  onClick = {() => history.push('/AudioBooks')}/>
          ...
          {collapsed1 === false ?
           ...
           onClick = {() => history.push('/Reviews')}/>}>
            ...
            <text className = "reviews-text" onClick = {() => history.push('/Reviews')}>
            Reviews
            </text>

            <img src = {require("../Assets/Images/notification.png")} alt = "img2" style = {{height: '11px', width: '11px', marginLeft: "66px"}}  onClick = {() => history.push('/Settings')}/>
          ...
          <text className = "settings-text" onClick = {() => history.push('/Settings')}>Settings</text>
      ...
      <Sider trigger = {null} collapsible collapsed={collapsed1} theme = "light" className = "sider" collapsedWidth = {0} width = "100%">      
    ...
    <img src = {require("../Assets/Images/logo.png")} alt = "img1" className = "audiobookrocket-logo-mobile"/>

    : null}

    {collapsed1 === false ? 

    <Menu.Item className = "listener-dashboard-mobile">Listener Dashboard</Menu.Item>

    : null}

    <Menu.Item key="1" icon ={<img className = {collapsed1 ? "collapsed-home" : "home-mobile"} src = {require("../Assets/Images/home.png")} alt = "img2"/>}>

        {collapsed1 === false ? 
         
        <text className = "dashboard-mobile" onClick = {() => {history.push('./'); onCollapse();}}  >Dashboard</text>
      ...
      {collapsed1 ? {height: "16.0px", width: "22px", textAlign: "center", marginTop: "-5px", marginLeft: "4px"} :
      {height: "21.33px", width: "29.26px", textAlign: "center", marginTop: "-5px", marginLeft: "-3px"}
    
      } src = {require("../Assets/Images/audioBooks.png")} alt = "img2"/> 

      {collapsed1 === false ?

      <text className = "audiobook-text-mobile" onClick = {() => {history.push('/AudioBooks'); onCollapse();}}>
      Audiobooks
      </text>
      ...
      <img src = {require("../Assets/Images/notification.png")} alt = "img2" style = {{height: '15px', width: '15px', marginLeft: "39px"}}  onClick = {() => history.push('/AudioBooks')}/>
      ...
      onClick = {() => {history.push('/AudioBooks'); onCollapse();}} >

      {collapsed1 === false ?

      <img src = {require("../Assets/Images/notification.png")} alt = "img2" style = {{height: '15px', width: '15px', marginLeft: "38px"}} 
       onClick = {() => {history.push('/AudioBooks'); onCollapse();}}
      />
      ...
      }  onClick = {() => {history.push('/Reviews'); onCollapse();}} >
      ...
      {collapsed1 === false ?
       ...
       <Menu.Item key="3" icon ={<img src = {require("../Assets/Images/star.png")} alt = "img2" style = {{height: '17.84px', width: '18.67px', textAlign: 'center', marginTop: "-5px", marginLeft: "1px"}} 
       onClick = {() => {history.push('/Reviews'); onCollapse();}}/>}>

        <text className = "reviews-text-mobile" onClick = {() => {history.push('/Reviews'); onCollapse();}}>
        Reviews
        </text>

        <img src = {require("../Assets/Images/notification.png")} alt = "img2" style = {{height: '15px', width: '15px', marginLeft: "73px"}}  onClick = {() => {history.push('/Settings'); onCollapse();}}/>
      ...
      <Menu.Item key="4" icon ={<img src = {require("../Assets/Images/settings.png")} alt = "img2" style = {{height: '30px', width: '30px', textAlign: 'center', marginTop: "-5px", marginLeft: "-4px"}}  onClick = {() => history.push('/Settings')}/>}>
        
      <text className = "settings-text-mobile" onClick = {() => {history.push('/Settings'); onCollapse();}}>Settings</text>
