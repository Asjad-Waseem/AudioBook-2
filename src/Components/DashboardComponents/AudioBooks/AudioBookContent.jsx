...
const onLink1 = () => {
  ...
  const onLink3 = () => {
    ...
    return (
            ...
            <div className="row">
            <Link className = "confirmed-reviews-mobile" onClick = {onLink1} style = {{color: link1}}>
            Confirmed Reviews</Link> 
            <p className = "numbers-mobile">1</p>
            </div>  

            <div className = "row">
            <Link className = "confirmed-reviews-mobile" onClick = {onLink2} style = {{color: link2}}>
            Disputes</Link> 
            <p className = "numbers-mobile">0</p>
            </div>

            <div className = "row">
            <Link className = "confirmed-reviews-mobile" onClick = {onLink3} style = {{color: link3}}>
            Requested</Link>
            ...
            <div className="col requiresReview">
            <div className = "table-responsive"> 

            {link1 === "Black" ? 

            <h4 className = "AudiobooksTableTitle">Audiobooks requiring review</h4>
           
            : 

            link2 === "Black" ? 

            <h4 className = "AudiobooksTableTitle">Audiobooks in dispute</h4>

            : 

            link3 === "Black" ? 
            <h4 className = "AudiobooksTableTitle">Requested audiobooks</h4>
            : 
